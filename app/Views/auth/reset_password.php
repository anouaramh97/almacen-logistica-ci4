...
<div class="auth-grid">
    <section class="auth-showcase">
        <div class="hero-kicker">Nueva contrasena</div>
        <h2>Crea una contrasena nueva</h2>
        <p class="hero-text">Usa una contrasena de al menos 8 caracteres para proteger tu cuenta.</p>
    </section>
    <section class="auth-card">
        <div class="heading"><h2>Cambiar contrasena</h2><p class="helper">Introduce y confirma tu nueva contrasena.</p></div>
